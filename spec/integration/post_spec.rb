...
RSpec.describe 'User integration tests', type: :feature do
    before(:each) do
        @user = User.create(name: 'Tom', photo: 'https://unsplash.com/photos/F_-0BxGuVvo1', bio: 'Teacher from Mexico.', posts_counter: 4)
        @commentor = User.create(name: 'John', photo: 'https://unsplash.com/photos/F_-0BxGuVvo2', bio: 'Teacher from USA.')
    ...
    describe 'index' do
        ...
        it 'should display the number of post of the user' do
        ...
        it 'should display a pagination for the posts' do
