...
RSpec.describe 'User integration tests', type: :feature do
    before(:each) do
        @user1 = User.create(name: 'Tom', photo: 'https://unsplash.com/photos/F_-0BxGuVvo1', bio: 'Teacher from Mexico.', posts_counter: 4)
        @user2 = User.create(name: 'John', photo: 'https://unsplash.com/photos/F_-0BxGuVvo2', bio: 'Teacher from Mexico.', posts_counter: 7)
        @user3 = User.create(name: 'Mary', photo: 'https://unsplash.com/photos/F_-0BxGuVvo3', bio: 'Teacher from Mexico.', posts_counter: 2)
